...
3. Revalidate against the current issue revision or PR head. Pass the receipt and only current fixer-ready findings to `$issue-fixer` or `$pr-fixer`; do not duplicate baseline retrieval or post completion replies after failure.
